        ...
        <Section>
          ...
          <div>
            <Collapse isOpen={mode!=='normal'}>
              <div>
                ...
                <ImageSelect
                  icons={[
                    { img: `${resPath}/lol/tier/bronze.png`, id: 'bronze', label: '브론즈' },
                    { img: `${resPath}/lol/tier/silver.png`, id: 'silver', label: '실버' },
                    { img: `${resPath}/lol/tier/gold.png`, id: 'gold', label: '골드' },
                    { img: `${resPath}/lol/tier/platinum.png`, id: 'platinum', label: '플래티넘' },
                    { img: `${resPath}/lol/tier/diamond.png`, id: 'diamond', label: '다이아몬드' },
                    { img: `${resPath}/lol/tier/master.png`, id: 'master', label: '마스터' },
                    { img: `${resPath}/lol/tier/grandmaster.png`, id: 'grandmaster', label: '그랜드마스터' },
                    { img: `${resPath}/lol/tier/challenger.png`, id: 'challenger', label: '챌린저' },
                  ]}
          ...
          <Collapse isOpen={mode!== 'chess'}>
            <div>
              ...
              <ImageSelect
                icons={[
                  { img: `${resPath}/lol/line/top.png`, id: 'top', label: '탑' },
                  { img: `${resPath}/lol/line/md.png`, id: 'mid', label: '미드' },
                  { img: `${resPath}/lol/line/ad.png`, id: 'bottom', label: '바텀' },
                  { img: `${resPath}/lol/line/jg.png`, id: 'jungle', label: '정글' },
                  { img: `${resPath}/lol/line/sp.png`, id: 'supporter', label: '서포터' },
                  { img: `${resPath}/lol/line/all.png`, id: 'all', label: '상관없음' },
                ]}
                style={{ justifyContent: 'left' }}
                selections={selection => {
          ...
          <AlignLayout align={'right'}>
            <Button color={'primary'} onClick={this.requestStart} size={'large'}>시작 &gt;</Button>
          </AlignLayout>
        </Section>
        <br />
      </div>
