    ...
    uiKit.popup.make(
      <div>
        ...
        <div>
          <h5>
            답장하기
            <div className={'explain'}>사진 첨부는 불가능합니다</div>
          </h5>
          ...
          <AlignLayout align={'right'}>
            <Button
              onClick={async () => {
                ...
                uiKit.loading.start();
                await replyComplain(auth, complain.id, data.body)
                  .then(response => {
                    //ok
                    uiKit.popup.destroy();
    ...
    return (
      <div>
        ...
        >
          ...
          >
            <MenuItem value="">모든 문의 보기</MenuItem>
            <MenuItem value={'wait'}>답변되지 않은 문의만</MenuItem>
          </Select>
        </FormControl>
        <br />
        <br />
        {complains &&
          complains.map(complain => {
            if (filter === 'wait' && complain.reply) return <div />;
