...
export const privacy = (
  <div className="panel panel_white" style={{ fontSize: '0.8rem' }}>
    ...
    <p className="ls2 lh6 bs5 ts4">
      <em className="emphasis">&lt;커플피커&gt;('티밍')</em> 은(는) 회사는
      개인정보처리방침을 개정하는 경우 웹사이트 공지사항(또는 개별공지)을 통하여
      공지할 것입니다.
    </p>
    <p className="ls2">
      ○ 본 방침은부터 <em className="emphasis">2019</em>년{' '}
      <em className="emphasis">11</em>월 <em className="emphasis">1</em>일부터
      시행됩니다.
    </p>
    <br />
    <p className="lh6 bs4">
    ...
    <p className="ls2">
      ...
      유지·관리, 서비스 부정이용 방지, 각종 고지·통지, 고충처리, 분쟁 조정을
    ...
    <p className="ls2">
      서비스 제공, 콘텐츠 제공, 맞춤 서비스 제공 등을 목적으로 개인정보를
      처리합니다.
    </p>
    <br />
    ...
    <p className="ls2">
      1. 개인정보 파일명 : 회원정보 및 활동기록
      <br /> - 개인정보 항목 : 이메일, 비밀번호, 성별
      <br /> - 수집방법 : 홈페이지
      <br /> - 보유근거 : 서비스 이용 및 범죄 예방 및 조치
      <br /> - 보유기간 : 1년
      <br /> - 관련법령 :
    </p>
    <br />
    ...
    <p className="lh6 bs4">
      ...
      <br />
      <br />① <em className="emphasis">&lt;커플피커&gt;('티밍')</em>은(는)
      법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집시에
    ...
    <p className="ls2">
      ① 정보주체는 커플피커에 대해 언제든지 개인정보 열람,정정,삭제,처리정지
      요구 등의 권리를 행사할 수 있습니다.
      <br />② 제1항에 따른 권리 행사는커플피커에 대해 개인정보 보호법 시행령
      제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
      있으며 커플피커은(는) 이에 대해 지체 없이 조치하겠습니다.
      <br />③ 제1항에 따른 권리 행사는 정보주체의 법정대리인이나 위임을 받은 자
      등 대리인을 통하여 하실 수 있습니다. 이 경우 개인정보 보호법 시행규칙 별지
      ...
      <br />⑥ 커플피커은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
    ...
    <p className="lh6 bs4">
      <strong>
        6. 개인정보의 파기<em className="emphasis">&lt;커플피커&gt;('티밍')</em>
    ...
    <p className="ls2">
      ① 커플피커 은 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고
    ...
    <br /> ① 커플피커(‘https://tming.kr’이하 ‘티밍) 은(는) 개인정보 처리에 관한
    ...
    <p className="ls2">
      ...
      직급 :대표
      <br />
      연락처 :01068521581, tming.dev@gmail.com,
      ...
      <br />
      연락처 :, ,
      <br />② 정보주체께서는 커플피커(‘https://tming.kr’이하 ‘티밍) 의
      서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의,
      불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로
      문의하실 수 있습니다. 커플피커(‘https://tming.kr’이하 ‘티밍) 은(는)
    ...
    <p className="lh6 bs4">
      <strong>
        10. 개인정보의 안전성 확보 조치{' '}
        <em className="emphasis">&lt;커플피커&gt;('티밍')</em>은(는)
    ...
    <p className="ls2">
      ...
      <br />
      2. 해킹 등에 대비한 기술적 대책
      <br /> &lt;<em className="emphasis">커플피커</em>&gt;('
      <em className="emphasis">티밍</em>')은 해킹이나 컴퓨터 바이러스 등에 의한
