    ...
    return (
      <div>
        <PageTitle
          title={'Uikit'}
          explain={
            'you can make Toast, Popup(Dialog), Exception, Loading using uiKit'
          }
          centering
        />

        <div className={'centering childMargin'}>
          <Button color={'primary'} onClick={this.makeToast}>
            Toast
          </Button>
          <Button color={'secondary'} onClick={this.openPopup}>
            Popup
          </Button>
          <Button color={'danger'} onClick={this.raiseException}>
            Exception
          </Button>
          <Button color={'info'} onClick={this.onLoading}>
            Loading
          </Button>
        </div>
      </div>
